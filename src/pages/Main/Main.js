  ...
  return (
    <>
      ...
      <div className={styles.downContent}>
          ...
          <StepCard text={{p:'Если нет, указываете контактные данные о друге, и отправляете ему ссылку на заполнение анкеты (можно анонимно, через наш сервис)', h4:'2 минуты'}}/>
